...
$(INSTALLED_P1LN_KERNEL_TARGET): $(KERNEL_P1LN_OUT) $(KERNEL_P1LN_CONFIG)
...
$(INSTALLED_BOOTIMAGE_TARGET): $(INSTALLED_KERNEL_TARGET) $(INSTALLED_P1LN_KERNEL_TARGET) $(PRODUCT_OUT)/utilities/flash_image $(PRODUCT_OUT)/utilities/busybox $(PRODUCT_OUT)/utilities/make_ext4fs $(PRODUCT_OUT)/utilities/erase_image
	$(ACP) -fp $< $@
